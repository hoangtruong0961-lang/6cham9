...
import { Plus, Trash2, ChevronUp, ChevronDown, CheckCircle2, Globe, RefreshCw, Sparkles, Sliders, Database, Shield, Zap, Palette, Monitor, HardDrive, Server, Paintbrush, Mic, Volume2 } from 'lucide-react';
