  ...
  return (
    <div className="flex flex-col h-full w-full relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-2 sm:p-4 md:p-8 relative z-10 w-full overflow-hidden mt-safe">
        ...
        {/* Dynamic Wizard Card - Neumorphic Outer Container */}
        <div className="w-full max-w-5xl flex-1 flex flex-col bg-[#e6ebf4] dark:bg-[#0b1329] border border-[#cbd2df]/30 dark:border-[#142042]/20 rounded-3xl shadow-[12px_12px_24px_#cbd2df,-12px_-12px_24px_#ffffff] dark:shadow-[12px_12px_24px_#030610,-12px_-12px_24px_#142042] min-h-0 mx-auto p-4 md:p-8 space-y-6 overflow-y-auto custom-scrollbar">
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Input Section - Neumorphic Recessed Well */}
            <div className="space-y-4 bg-[#e6ebf4] dark:bg-[#0b1329] p-6 rounded-2xl border border-[#cbd2df]/30 dark:border-[#142042]/20 shadow-[inset_4px_4px_8px_#cbd2df,inset_-4px_-4px_8px_#ffffff] dark:shadow-[inset_4px_4px_8px_#030610,inset_-4px_-4px_8px_#142042]">
              ...
              <div>
                ...
                <Button 
                  ...
                  className="w-full justify-center bg-mystic-accent text-mystic-950 font-black tracking-wider shadow-[3px_3px_6px_#cbd2df,-3px_-3px_6px_#ffffff] dark:shadow-[3px_3px_6px_#030610,-3px_-3px_6px_#142042] hover:scale-[1.01] active:scale-[0.99] transition-transform"
                  disabled={isTraining}
                >
              ...
              {files.length > 0 && (
                <div className="bg-[#cbd2df]/20 dark:bg-[#030610]/30 p-3 rounded-xl border border-[#cbd2df]/30 dark:border-[#142042]/10 shadow-inner">
                  ...
                  <ul className="space-y-2 max-h-32 overflow-y-auto custom-scrollbar">
                    {files.map((f, idx) => (
                      <li key={idx} className="flex items-center justify-between text-xs bg-[#e6ebf4] dark:bg-[#0b1329] border border-[#cbd2df]/20 dark:border-[#142042]/10 px-3 py-2 rounded-lg shadow-sm">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#cbd2df]/20 dark:bg-[#030610]/45 border border-[#cbd2df]/30 dark:border-[#142042]/25 rounded-xl px-4 py-2.5 text-xs text-stone-900 dark:text-slate-200 focus:outline-none focus:border-mystic-accent transition-all font-semibold shadow-[inset_1px_2px_4px_rgba(0,0,0,0.06)] dark:shadow-[inset_1px_2px_4px_rgba(0,0,0,0.5)]"
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#cbd2df]/20 dark:bg-[#030610]/45 border border-[#cbd2df]/30 dark:border-[#142042]/25 rounded-xl px-3 py-2.5 text-xs text-stone-900 dark:text-slate-200 focus:outline-none focus:border-mystic-accent transition-all font-semibold shadow-[inset_1px_2px_4px_rgba(0,0,0,0.06)] dark:shadow-[inset_1px_2px_4px_rgba(0,0,0,0.5)] cursor-pointer"
                  disabled={isTraining}
                >
                  <option value="global" className="bg-[#e6ebf4] dark:bg-[#0b1329] text-stone-900 dark:text-slate-200">Không liên kết riêng (Chia sẻ chung toàn hệ thống)</option>
                  {characters.map(char => (
                    <option key={char.id} value={char.id} className="bg-[#e6ebf4] dark:bg-[#0b1329] text-stone-900 dark:text-slate-200">Nhân vật: {char.name}</option>
                  ))}
                </select>
            ...
            {/* Settings Section - Neumorphic Recessed Well */}
            <div className="space-y-4 bg-[#e6ebf4] dark:bg-[#0b1329] p-6 rounded-2xl border border-[#cbd2df]/30 dark:border-[#142042]/20 shadow-[inset_4px_4px_8px_#cbd2df,inset_-4px_-4px_8px_#ffffff] dark:shadow-[inset_4px_4px_8px_#030610,inset_-4px_-4px_8px_#142042] flex flex-col justify-between">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`px-3 py-2.5 text-xs font-black tracking-wider rounded-xl border transition-all ${
                        chunkingStrategy === 'parent-child'
                          ...
                          : 'bg-[#e6ebf4] dark:bg-[#0b1329] border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 shadow-[3px_3px_6px_#cbd2df,-3px_-3px_6px_#ffffff] dark:shadow-[3px_3px_6px_#030610,-3px_-3px_6px_#142042]'
                      }`}
                      disabled={isTraining}
                    >
                      Parent-Child Chunking
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      min={50}
                      className="w-full bg-[#cbd2df]/20 dark:bg-[#030610]/45 border border-[#cbd2df]/30 dark:border-[#142042]/25 rounded-xl px-3 py-2 text-xs text-stone-900 dark:text-slate-200 outline-none font-semibold shadow-[inset_1px_1px_3px_rgba(0,0,0,0.06)] dark:shadow-[inset_1px_1px_3px_rgba(0,0,0,0.5)]"
                      disabled={isTraining}
                    />
                  </div>
                ...
                <div className="space-y-2 pt-2 border-t border-[#cbd2df]/30 dark:border-[#142042]/20">
                  <label className="flex items-center gap-2 cursor-pointer select-none">
                    <input 
                      ...
                      disabled={isTraining}
                      className="rounded border-[#cbd2df]/50 dark:border-slate-700 text-mystic-accent focus:ring-mystic-accent bg-[#e6ebf4] dark:bg-[#0b1329] w-4 h-4"
                    />
                ...
                <div className="p-3.5 bg-[#e0e6f0]/40 dark:bg-[#080d1c]/45 border border-[#cbd2df]/30 dark:border-[#142042]/10 rounded-xl text-xs shadow-inner">
              ...
              <div className="pt-4">
                {!isTraining ? (
                  <Button 
                    ...
                    className="w-full justify-center bg-green-500 hover:bg-green-600 text-green-950 font-black tracking-widest py-3.5 rounded-xl shadow-[3px_3px_6px_rgba(16,185,129,0.35)] dark:shadow-[3px_3px_6px_rgba(0,0,0,0.5)] active:scale-[0.98] transition-transform uppercase text-xs font-sans"
                  >
                  ...
                  <Button 
                    ...
                    className="w-full justify-center bg-red-500 hover:bg-red-600 text-white font-black tracking-widest py-3.5 rounded-xl shadow-[3px_3px_6px_rgba(239,68,68,0.35)] dark:shadow-[3px_3px_6px_rgba(0,0,0,0.5)] active:scale-[0.98] transition-transform uppercase text-xs animate-pulse font-sans"
                  >
          ...
          {useLangGraph && (
            <div className="bg-[#e6ebf4] dark:bg-[#0b1329] p-5 rounded-2xl border border-[#cbd2df]/30 dark:border-[#142042]/20 shadow-[inset_4px_4px_8px_#cbd2df,inset_-4px_-4px_8px_#ffffff] dark:shadow-[inset_4px_4px_8px_#030610,inset_-4px_-4px_8px_#142042] space-y-4">
              <h3 className="text-xs font-black text-slate-850 dark:text-slate-100 uppercase tracking-[0.15em] flex items-center gap-2">
                  ...
                  return (
                    <div 
                      ...
                      className={`p-3 rounded-xl border relative transition-all duration-300 ${
                        status === 'completed'
                          ? 'bg-emerald-500/10 border-emerald-500/40 text-emerald-600 dark:text-emerald-350 shadow-[1px_2px_4px_#cbd2df] dark:shadow-[1px_2px_4px_#030610]'
                          : isActive
                          ? 'bg-[#e0e6f0]/60 dark:bg-[#080d1c]/60 border-mystic-accent/60 text-mystic-accent animate-pulse shadow-[inset_2px_2px_4px_#cbd2df] dark:shadow-[inset_2px_2px_4px_#030610]'
                          : 'bg-[#cbd2df]/15 dark:bg-[#030610]/20 border-transparent text-slate-500 dark:text-slate-550 shadow-sm'
                      }`}
                    >
                      <div className="absolute top-2 right-2 flex items-center justify-center">
                        {status === 'completed' ? (
                          ...
                          <span className="w-2 h-2 rounded-full bg-mystic-accent/90 animate-ping" />
                        ) : (
                          <span className="w-2 h-2 rounded-full bg-[#cbd2df] dark:bg-slate-800" />
                        )}
                      </div>
                      <div className="flex items-center gap-2 mb-1">
                        <Icon size={14} className={isActive ? 'text-mystic-accent' : status === 'completed' ? 'text-emerald-500' : 'text-slate-500'} />
                        <span className="text-[11px] font-black tracking-wide font-sans">{node.label}</span>
                      </div>
                      <p className="text-[9px] leading-tight text-slate-650 dark:text-slate-400 font-mono mt-1">{node.desc}</p>
                    </div>
                  );
                })}
              </div>
              ...
              {(liveEntities.length > 0 || liveEdges.length > 0) && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-[#cbd2df]/40 dark:border-[#142042]/20">
                  {/* Extracted entities */}
                  <div className="space-y-2">
                    <h4 className="text-[10px] uppercase font-mono text-slate-550 dark:text-slate-400 font-bold flex items-center gap-1">
                      <Cpu size={12} className="text-blue-500" /> Thực thể vừa lọc (Live Entities):
                    </h4>
                    <div className="flex flex-wrap gap-1.5 max-h-16 overflow-y-auto custom-scrollbar p-2 bg-[#e0e6f0]/40 dark:bg-[#080d1c]/45 border border-[#cbd2df]/30 dark:border-[#142042]/10 rounded-xl shadow-inner">
                      {liveEntities.map((ent, eIdx) => (
                        <span key={eIdx} className="text-[9px] bg-blue-500/10 border border-blue-400/20 text-blue-600 dark:text-blue-300 font-mono px-2 py-0.5 rounded-full" title={ent.description}>
                          [{ent.label}] {ent.name}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-1.5 max-h-16 overflow-y-auto custom-scrollbar p-2 bg-[#e0e6f0]/40 dark:bg-[#080d1c]/45 border border-[#cbd2df]/30 dark:border-[#142042]/10 rounded-xl shadow-inner">
                      {liveEdges.map((edg, edIdx) => (
                        <span key={edIdx} className="text-[9px] bg-pink-500/10 border border-pink-400/20 text-pink-600 dark:text-pink-300 font-mono px-2 py-0.5 rounded">
          ...
          {/* Terminal Box */}
          <div className="bg-[#080d19] rounded-2xl border border-[#cbd2df]/30 dark:border-[#142042]/20 shadow-[4px_4px_10px_#cbd2df,-4px_-4px_10px_#ffffff] dark:shadow-[4px_4px_10px_#030610,-4px_-4px_10px_#142042] overflow-hidden flex flex-col h-[280px] shrink-0">
             <div className="bg-[#111726] px-4 py-2 border-b border-white/5 flex justify-between items-center">
                <span className="text-[10px] font-mono text-slate-400 flex items-center gap-1.5">
                   <span className="w-2.5 h-2.5 rounded-full bg-green-550/90 animate-ping inline-block" />
             ...
             <div 
               ref={logContainerRef}
               className="flex-1 p-4 overflow-y-auto font-mono text-[11px] text-slate-350 space-y-1 custom-scrollbar leading-relaxed"
             >
               {logs.length === 0 && (
                 <div className="text-slate-550 italic">Vui lòng tải lên tài liệu nguồn và cấu hình rồi nhấn khởi động...</div>
               )}
               {logs.map((log, i) => (
                 <div key={i} className="border-l border-white/5 pl-2 text-slate-300">
                   {log}
                 </div>
               ))}
             </div>
