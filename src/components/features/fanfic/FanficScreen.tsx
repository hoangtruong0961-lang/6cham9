...
import { 
  ...
  RefreshCw, Clock, Sparkle, AlertCircle
} from 'lucide-react';
...
export const FanficScreen: React.FC<FanficScreenProps> = ({ onNavigate, onGameStart, initialData }) => {
  ...
  return (
    <div className="flex flex-col h-full w-full relative overflow-hidden bg-slate-50 dark:bg-[#030712] transition-colors duration-500">
      ...
      {/* Main container with clean centering */}
      <div className="flex-grow flex flex-col max-w-5xl w-full mx-auto p-4 md:p-8 z-10 overflow-y-auto no-scrollbar justify-center">
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 'INPUT' && (
            ...
            >
              ...
              {/* Mode Select Buttons */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-slate-150 dark:border-slate-800/40">
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[11px] text-slate-400 mt-1 max-w-sm">
                      AI tự động thiết lập các mốc thời gian (Timeline) và nhân vật. 
                      Lựa chọn vai kịch bản và chơi ngay tức khắc. Rất tự do và linh hoạt vừa chơi vừa tìm kiếm.
                    </p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-center">
                    <h3 className="font-extrabold text-sm uppercase tracking-wider text-slate-700 dark:text-slate-200">
                      2. ĐIỀN TẤT CẢ (WORLD CREATOR)
                    </h3>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 max-w-sm">
                      AI sẽ tự động sinh ngẫu nhiên toàn diện cốt truyện, địa lý, khu vực, nhân vật vào kho World Creator để bạn thoải mái chỉnh sửa từng ô.
                    </p>
                  </div>
                </button>
              </div>
